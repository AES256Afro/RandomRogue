...
seed: geography, factions, 1,000 years of simulated history across five eras, and every rumor,
...
the same seed -ù that's load-bearing; see the determinism note in
...
the landing page + game from a KV namespace -ù independent of GitHub, so repo
